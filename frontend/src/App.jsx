...
function App() {
  ...
  useEffect(() => {
    if (user) {
      localStorage.setItem('yarntales-user', JSON.stringify(user))
    } else {
      localStorage.removeItem('yarntales-user')
    }
  }, [user])

  useEffect(() => {
    if (lastOrderId) {
      localStorage.setItem('yarntales-last-order', lastOrderId)
    } else {
      localStorage.removeItem('yarntales-last-order')
    }
  }, [lastOrderId])
    ...
    <main className="auth-page">
      <section className="auth-visual">
        ...
        <div className="auth-visual-copy">
          ...
          <p>
            Shop crochet pieces that feel personal, playful and a little bit you.
          </p>
        </div>
      ...
      <section className="auth-card">
        ...
        <div className="auth-title">
          ...
          <h2>
            {mode === 'signin'
              ? 'Come back to your cozy corner.'
              : 'Make your own cozy corner.'}
          </h2>

          <p>
            {mode === 'signin'
              ? 'Your saved pieces are waiting.'
              : 'Save favourites and make checkout easier.'}
          </p>
        </div>
  ...
  return (
    <header className="topbar">
      ...
      <nav className={`nav ${mobileMenu ? 'open' : ''}`}>
        ...
        >
          Wishlist <sup>{wishlistCount}</sup>
        </button>
    ...
    <main>
      <section className="home-hero">
        <div className="hero-copy">
          ...
          <h1>
            ...
            <br />
            <em>stitched just for you.</em>
          </h1>

          <p>
            Real crochet. Small batches. Cute little things made to be gifted,
            carried, clipped on and loved.
          </p>
        ...
        <div className="hero-photo-grid">
          <div className="hero-photo tall">
            <img
              src={resolveAsset("/src/assets/black-yellow-bow-bag.jpg")}
              alt="Crochet black and yellow bow bag"
            />
            <span>the bow girl ♡</span>
          </div>

          <div className="hero-photo">
            <img
              src={resolveAsset("/src/assets/flower-bookmark.jpg")}
              alt="Floral crochet bookmark"
            />
          </div>

          <div className="hero-photo">
            <img
              src={resolveAsset("/src/assets/cherry-keychain.jpg")}
              alt="Crochet cherry keychain"
            />
          </div>

          <div className="hero-photo">
            <img
              src={resolveAsset("/src/assets/navy-daisy-fringe-bag.jpg")}
              alt="Navy crochet fringe bag"
            />
          </div>
      ...
      <section className="story-strip">
        <div className="story-photo">
          <img
            src={resolveAsset("/src/assets/black-flower-scarf-flat.jpg")}
            alt="Handmade black and cream crochet scarf"
          />
        </div>
        ...
        <div className="story-copy">
          ...
          <p>
            From tiny keychains to everyday bags, every piece is made slowly
      ...
      <section className="home-section cream">
        ...
        <div className="moodboard">
          {catalogProducts.slice(1, 10).map((product, index) => (
            <button
              className={`mood-card mood-${(index % 6) + 1}`}
              key={product.id}
      ...
      <section className="home-section pinkwash">
        <SectionHeader
          title="Loved by cozy collectors"
          subtitle="Sweet little notes from customers in India."
        />
      ...
      <section className="instagram-banner">
        <div className="insta-copy">
          ...
          <p>
            See new pieces, behind-the-scenes crochet and the real YarnTales mood.
          </p>

          <a
            className="primary-cta link-button"
            href={IG_URL}
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="insta-grid">
          {[
            ...
            <img
              key={src}
              src={src}
              alt={`YarnTales Instagram preview ${index + 1}`}
            />
          ))}
        </div>
      </section>
  ...
  return (
    <main className="page-section">
      <div className="page-intro">
        ...
        <p>
          Pick a bag, add a tiny charm, or find something made for your next
          reading day.
        </p>
      </div>
      ...
      <div className="shop-layout">
        ...
        <div className="shop-grid">
          {list.length ? (
            ...
            <EmptyState
              title="No little finds here."
              text="Try another word or category."
            />
          )}
        </div>
      </div>
    ...
    <main className="page-section">
        ...
        <div className="product-info">
          ...
          <div className="accordion">
            <div>
              <b>Details</b>
              <span>
                Made by hand with soft yarn and careful finishing.
              </span>
            </div>
            ...
            <div>
              <b>Care</b>
              <span>
                Keep dry and spot-clean gently when needed.
              </span>
            </div>
            ...
            <div>
              <b>Shipping</b>
              <span>
                Made-to-order pieces may take a few days before dispatch.
              </span>
            </div>
          </div>
      ...
      <section className="section-inner">
        <SectionHeader
          ...
          subtitle="A few more things you might love."
        />
  ...
  return (
    <main className="page-section">
      <div className="page-intro row-intro">
        <div>
          <span className="eyebrow">✦ CUSTOM CORNER</span>

          <h1>Make it yours.</h1>

          <p>
            Pick the shape, colour and little detail. Keep the words simple —
            keep the piece personal.
          </p>
        </div>

        <span className="price-pill">from ₹1,999</span>
      </div>
      ...
      <div className="builder">
        <div className="builder-preview">
          ...
          <img
            src={previewImage}
            alt="Custom crochet preview"
          />

          <div className="preview-caption">
            <b>{colour} {base}</b>
            <span>{detail} · made for you</span>
          </div>
        </div>
        ...
        <div className="builder-controls">
          <BuilderStep number="01" title="Choose your base">
            <div className="choice-grid">
              {['Mini Bag', 'Pouch', 'Keychain'].map((item) => (
                <button
                  key={item}
                  className={base === item ? 'selected' : ''}
          ...
          <BuilderStep number="03" title="Choose the detail">
            <div className="choice-row wrap">
              {['Bow', 'Flower', 'Heart', 'Name tag'].map((item) => (
                <button
                  key={item}
          ...
          <div className="builder-bottom">
            ...
            <button
              ...
              onClick={() => {
                if (!template?.id) {
                  notify(
                    'Custom builder is still loading — please try again.'
                  )
                  return
                }
...
function GiftPage({
  ...
  return (
    <main className="page-section">
      <div className="page-intro row-intro">
        <div>
          <span className="eyebrow">✦ GIFT MODE ✨</span>

          <h1>Tell us a little about them.</h1>

          <p>
            We'll help you find something that feels personal.
          </p>
        </div>

        <span className="gift-badge">gift helper on</span>
      </div>
        ...
        <BuilderStep number="01" title="Who is it for?">
          <div className="recipient-grid">
            {[
              ...
              >
                <span>{item.slice(4, 5)}</span>
                <b>{item}</b>
                <small>cute picks</small>
              </button>
            ))}
          </div>
        </BuilderStep>
    ...
    <main className="page-section">
      ...
      {wishlist.length ? (
        ...
        <EmptyState
          ...
          text="Save the little things you love."
          action="Browse shop"
          onAction={() => navigate('shop')}
        />
      )}
  ...
  return (
    <main className="page-section">
      <div className="page-intro">
        ...
        <h1>Your Cozy Cart</h1>

        <p>
          {cart.length
            ? 'Almost yours.'
            : 'Nothing here yet — let’s find something cute.'}
        </p>
      </div>
      ...
      {cart.length ? (
        <div className="cart-layout">
          <div className="cart-list">
            ...
            <div className="shipping-hint">
              {shipping
                ? `Add ${money(2500 - cartTotal)} more for free shipping`
        ...
        <EmptyState
          ...
          text="Find something soft, cute or useful."
...
function TrackingPage({ orderId, navigate }) {
    ...
    getOrderTracking(orderId)
      ...
      .catch(
        (err) =>
          active &&
          setError(
            err.message || 'Unable to load order tracking'
          )
      )
  ...
  const labels = {
    ...
    materials_sourced: [
      'Materials sourced',
      'The yarn and supplies are ready.',
    ],
    handcrafting_in_progress: [
      'Being made',
      'Your piece is being crocheted with care.',
    ],
    quality_check: [
      'Quality check',
      'We are checking every little detail.',
    ],
    packed: [
      'Packed',
      'Wrapped and ready to leave us.',
    ],
    dispatched: [
      'On the way',
      'Your parcel is heading to you.',
    ],
    delivered: [
      'Delivered',
      'Your YarnTales piece has arrived.',
    ],
  }
  ...
  const current =
    tracking?.currentStatus || 'order_confirmed'
    ...
    <main className="page-section">
      ...
      <section className="tracking-card">
        ...
        <div className="maker-note">
          <div className="maker-avatar">Y</div>

          <div>
            <b>Made by a YarnTales maker</b>

            <span>
              Your piece is being prepared in India and packed with care.
            </span>
          </div>
        </div>
  ...
  return (
    <main className="page-section narrow">
      <div className="page-intro">
        ...
        <h1>Take care of your cozy things.</h1>

        <p>
          Every YarnTales piece is handmade with love.
          A little gentle care will help your crochet stay
      ...
      <div className="form-card">
        ...
        <ul>
          <li>
            Gently hand wash using cold or lukewarm water.
          </li>

          <li>
            Use a mild detergent or gentle soap.
          </li>
          ...
          <li>
            Avoid vigorous scrubbing, twisting, or wringing.
          </li>

          <li>
            For small stains, gently dab the affected area
            with a damp cloth.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Gently press the item with a clean towel to
            remove excess water.
          </li>

          <li>
            Reshape the piece while it is still damp.
          </li>

          <li>
            Lay it flat on a clean, dry towel and allow it
            to air dry.
          </li>

          <li>
            Do not use a tumble dryer or direct heat.
          </li>

          <li>
            Avoid using a hair dryer directly on the yarn.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Store crochet pieces in a clean and dry place.
          </li>
          ...
          <li>
            Do not place heavy objects on top of crochet pieces.
          </li>

          <li>
            Keep plush items away from prolonged direct sunlight.
          </li>
        </ul>
        ...
        <p>
          Some pieces may contain delicate details such as
          embroidered features, ribbons, accessories, or small
          decorations. Please handle these parts gently.
        </p>

        <h2>✨ A Little Handmade Reminder</h2>

        <p>
          Small differences in stitching, shape, texture, and
          colour are natural characteristics of handmade
          crochet products. These little variations make every
          YarnTales creation unique.
        </p>
      </div>
    </main>
  )
  ...
  return (
    <main className="page-section narrow">
      <div className="page-intro">
        ...
        <p>
          Your order is carefully prepared, packed and sent
          to you with love.
        </p>
      </div>
      ...
      <div className="form-card">
        ...
        <p>
          YarnTales currently delivers across India.
        ...
        <ul>
          <li>
            <strong>Ready-to-ship products:</strong> 2–4
            business days.
          </li>
        ...
        <p>
          Once your order has been dispatched, delivery
          generally takes approximately 3–7 business days
        ...
        <p>
          You can track your order through the{' '}
          <strong>Order Tracking</strong> section of your
          YarnTales account.
        </p>

        <p>
          <strong>
            Order Confirmed → Materials Sourced →
            Handcrafting in Progress → Quality Check →
        ...
        <h2>⚠️ Delivery Delays</h2>

        <p>
          Delivery may occasionally take longer because of
          weather, courier delays, public holidays, incorrect
          addresses, remote locations, or other unexpected
          circumstances.
        </p>
      </div>
    </main>
  ...
  return (
    <main className="page-section narrow">
      <div className="page-intro">
        ...
        <p>
          We want you to be happy with your YarnTales order.
          Here is how returns and refunds work.
        </p>
      </div>
      ...
      <div className="form-card">
        ...
        <ul>
          ...
          <li>
            The product has a significant manufacturing defect.
          </li>

          <li>
            The item is substantially different from what
            was ordered.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            Personalized items containing names or messages.
          </li>

          <li>
            Products that have been used, washed, damaged,
            or altered.
          </li>

          <li>
            Items damaged because of improper care or handling.
          </li>
        </ul>
        ...
        <ol>
          <li>
            Take clear photographs of the product and
            packaging.
          </li>

          <li>
            Contact YarnTales as soon as possible.
          </li>

          <li>
            Provide your Order ID along with the photographs.
          </li>
        ...
        <p>
          If a return or refund request is approved, the
          refund will be processed according to the payment
        ...
        <p>
          Minor differences in stitching, shape, texture,
          or colour are natural characteristics of handmade
          products and are not considered defects.
        </p>
      </div>
    </main>
  )
      ...
      <div className="form-card inquiry-card">
        <label>
          ...
          <textarea
            ...
            rows="7"
            placeholder="Ask about colour, size, making time or anything else..."
          />
        </label>
  ...
  return (
    <footer className="footer">
      <div>
        ...
        <p>
          Little handmade things for big happy moments.
        </p>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2>Soft colours, tiny details.</h2>

        <p>
          These are the shades used throughout the site.
        </p>
